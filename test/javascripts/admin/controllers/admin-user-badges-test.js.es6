...
test("grantableBadges", function() {
  var badge_first = GameOfForums.Badge.create({id: 3, name: "A Badge"});
  var badge_middle = GameOfForums.Badge.create({id: 1, name: "My Badge"});
  var badge_last = GameOfForums.Badge.create({id: 2, name: "Zoo Badge"});
