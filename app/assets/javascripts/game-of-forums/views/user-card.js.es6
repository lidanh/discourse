import CleansUp from 'game-of-forums/mixins/cleans-up';
...
export default GameOfForums.View.extend(CleansUp, {
  elementId: 'user-card',
  ...
  addBackground: function() {
    ...
    if (Ember.isEmpty(url)) {
      ...
      $this.css('background-image', "url(" + GameOfForums.getURLWithCDN(url) + ")").removeClass('no-bg');
    }
