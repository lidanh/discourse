...
**/
GameOfForums.Eyeline = function Eyeline(selector) {
...
/**
  ...
  @method update
**/
GameOfForums.Eyeline.prototype.update = function() {
...
/**
  ...
  @method flushRest
**/
GameOfForums.Eyeline.prototype.flushRest = function() {
  var self = this;
...
RSVP.EventTarget.mixin(GameOfForums.Eyeline.prototype);
