const GameOfForumsRoute = Ember.Route.extend({
...
export function cleanDOM() {
  ...
  GameOfForums.set('notifyCount',0);
  ...
  const appEvents = GameOfForums.__container__.lookup('app-events:main');
  appEvents.trigger('dom:clean');
}

export default GameOfForumsRoute;
