export default function() {
  ...
  this.resource('discovery', { path: '/' }, function() {
    ...
    // top by periods
    var self = this;
    GameOfForums.Site.currentProp('periods').forEach(function(period) {
    ...
    // filters
    GameOfForums.Site.currentProp('filters').forEach(function(filter) {
    ...
    // homepage
    this.route(GameOfForums.Utilities.defaultHomepage(), { path: '/' });
  });
  ...
  this.resource('user', { path: '/users/:username' }, function() {
    this.resource('userActivity', { path: '/activity' }, function() {
      var self = this;
      _.map(GameOfForums.UserAction.TYPES, function (id, userAction) {
