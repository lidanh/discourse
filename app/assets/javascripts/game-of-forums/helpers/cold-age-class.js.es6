...
registerUnbound('cold-age-class', function(dt, params) {
  ...
  if (nowDays - epochDays > GameOfForums.SiteSettings.cold_age_days_high) return className + ' coldmap-high';
  if (nowDays - epochDays > GameOfForums.SiteSettings.cold_age_days_medium) return className + ' coldmap-med';
  if (nowDays - epochDays > GameOfForums.SiteSettings.cold_age_days_low) return className + ' coldmap-low';
