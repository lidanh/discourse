GameOfForums.computed = {
  ...
  **/
  ...
  /**
    Creates a URL using GameOfForums.getURL. It takes a fmt string just like
    fmt does.
  ...
  **/
  url: function() {
    ...
    var computed = Em.computed(function() {
      var self = this;
      return GameOfForums.getURL(format.fmt.apply(format, args.map(function (a) {
        return self.get(a);
      })));
    });
    return computed.property.apply(computed, args);
  ...
  **/
  setting: function(name) {
    return Em.computed(function() {
      return GameOfForums.SiteSettings[name];
    }).property();
  }
