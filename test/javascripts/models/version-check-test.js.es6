module("GameOfForums.VersionCheck");

test('dataIsOld', function() {
  var dataIsOld = function(args, expected, message) {
    equal(GameOfForums.VersionCheck.create(args).get('dataIsOld'), expected, message);
  };
...
test('staleData', function() {
  ...
  var staleData = function(args, expected, message) {
    equal(GameOfForums.VersionCheck.create(args).get('staleData'), expected, message);
  };
