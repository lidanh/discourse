module("GameOfForums.PreloadStore", {
  setup: function() {
...
asyncTestGameOfForums("getAndRemove returns a promise that resolves to null", function() {
  expect(1);
...
asyncTestGameOfForums("getAndRemove returns a promise that resolves to the result of the finder", function() {
  expect(1);
...
asyncTestGameOfForums("getAndRemove returns a promise that resolves to the result of the finder's promise", function() {
  expect(1);
...
asyncTestGameOfForums("returns a promise that rejects with the result of the finder's rejected promise", function() {
  expect(1);
...
asyncTestGameOfForums("returns a promise that resolves to 'evil'", function() {
  expect(1);
