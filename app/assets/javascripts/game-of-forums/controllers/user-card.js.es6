export default Ember.Controller.extend({
  ...
  showName: GameOfForums.computed.propertyNotEqual('user.name', 'user.username'),
  ...
  show(username, postId, target) {
    ...
    return GameOfForums.User.findByUsername(username, args).then((user) => {
