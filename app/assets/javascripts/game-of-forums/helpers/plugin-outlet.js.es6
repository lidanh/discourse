/**
   ...
   plugins/hello/assets/javascripts/game-of-forums/templates/connectors/evil-trout/hello.hbs
   ...
   plugins/hello/assets/javascripts/game-of-forums/views/connectors/evil-trout/hello.js.es6
...
function findOutlets(collection, callback) {
  ...
  const disabledPlugins = GameOfForums.Site.currentProp('disabled_plugins') || [];
