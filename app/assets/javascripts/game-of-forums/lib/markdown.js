 ...
 *
 * Code can insert into this map by calling GameOfForums.Markdown.whiteListTag().
 *
 * Example:
 *
 * <pre><code>
...
GameOfForums.Markdown = {
  ...
  **/
  createEditor: function(converterOptions) {
    ...
    var markdownConverter = GameOfForums.Markdown.markdownConverter(converterOptions);
  ...
  **/
  sanitize: function(text) {
    ...
    return window.html_sanitize(text, GameOfForums.Markdown.urlAllowed, validateAttribute);
  },
  ...
  markdownConverter: function(opts) {
    ...
    return {
      makeHtml: function(text) {
        text = GameOfForums.Dialect.cook(text, opts);
        return !text ? "" : text;
      }
    };
  }
...
RSVP.EventTarget.mixin(GameOfForums.Markdown);

GameOfForums.Markdown.whiteListTag('a', 'class', 'attachment');
GameOfForums.Markdown.whiteListTag('a', 'class', 'onebox');
GameOfForums.Markdown.whiteListTag('a', 'class', 'mention');

GameOfForums.Markdown.whiteListTag('a', 'target', '_blank');
GameOfForums.Markdown.whiteListTag('a', 'rel', 'nofollow');
GameOfForums.Markdown.whiteListTag('a', 'data-bbcode');
GameOfForums.Markdown.whiteListTag('a', 'name');

GameOfForums.Markdown.whiteListTag('img', 'src', /^data:image.*$/i);

GameOfForums.Markdown.whiteListTag('div', 'class', 'title');
GameOfForums.Markdown.whiteListTag('div', 'class', 'quote-controls');

GameOfForums.Markdown.whiteListTag('span', 'class', 'mention');
GameOfForums.Markdown.whiteListTag('span', 'class', 'spoiler');
GameOfForums.Markdown.whiteListTag('div', 'class', 'spoiler');
GameOfForums.Markdown.whiteListTag('aside', 'class', 'quote');
GameOfForums.Markdown.whiteListTag('aside', 'data-*');

GameOfForums.Markdown.whiteListTag('span', 'bbcode-b');
GameOfForums.Markdown.whiteListTag('span', 'bbcode-i');
GameOfForums.Markdown.whiteListTag('span', 'bbcode-u');
GameOfForums.Markdown.whiteListTag('span', 'bbcode-s');

// used for pinned topics
GameOfForums.Markdown.whiteListTag('span', 'class', 'excerpt');

GameOfForums.Markdown.whiteListIframe(/^(https?:)?\/\/www\.google\.com\/maps\/embed\?.+/i);
GameOfForums.Markdown.whiteListIframe(/^(https?:)?\/\/www\.openstreetmap\.org\/export\/embed.html\?.+/i);
