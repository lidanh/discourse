const rootURL = GameOfForums.BaseUri && GameOfForums.BaseUri !== "/" ? GameOfForums.BaseUri : undefined;

const BareRouter = Ember.Router.extend({
  rootURL,
  location: Ember.testing ? 'none': 'game-of-forums-location'
});
...
export function mapRoutes() {
  ...
  // If a module is defined as `route-map` in a plugin, its routes
